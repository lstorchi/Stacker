...
c1 = nanop1.get_center()
c2 = nanop2.get_center()
...
for i in range(len(xlist1)):
    xlist1[i] = xlist1[i] + c1[0]
    ylist1[i] = ylist1[i] + c1[1]
    zlist1[i] = zlist1[i] + c1[2]
...
for i in range(len(xlist2)):
    xlist2[i] = xlist2[i] + c2[0]
    ylist2[i] = ylist2[i] + c2[1]
    zlist2[i] = zlist2[i] + c2[2]
