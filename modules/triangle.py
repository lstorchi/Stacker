...
def get_vtk_actor (a, b, c, opacity = 1.0, rc = 1.0, gc = 1.0, bc = 1.0):
  points = vtk.vtkPoints()
  points.InsertNextPoint(a.get_x(), a.get_y(), a.get_z())
  points.InsertNextPoint(b.get_x(), b.get_y(), b.get_z())
  points.InsertNextPoint(c.get_x(), c.get_y(), c.get_z())
